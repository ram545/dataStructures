...
class MyTree{
	...
	public void removeRangeinBst(int min, int max){
		root = removeRanges(root,min,max);
	}

	public Node removeRanges(Node root, int min, int max){
		if( root == null )
			return null;

		root.left = removeRanges(root.left, min, max);
		root.right = removeRanges(root.right, min, max);
...
public class BSTRemElemRange{
	...
	public static void main(String args[]){
		BSTRemElemRange bc = new BSTRemElemRange();
		bst.insert(10);
		bst.insert(3);
		bst.insert(6);
		bst.insert(15);
